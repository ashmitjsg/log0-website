---
title: System Design
description: The full platform architecture - all seven services, five Kafka topics, three storage layers, and how they connect. Includes the multi-tenant model and service dependency map.
---
...
2. **AI summary** - The LLM provider is called asynchronously after the incident is created via a REST call to the AI Summary Service. It does not block the notification; engineers see the incident in Slack before the summary arrives.
...
| Clustering Service | 8082 | - (Kafka only) | ✅ Implemented |
| Incident Service | 8083 | HTTP + Kafka | ✅ Implemented |
| Notification Service | 8084 | HTTP + Kafka | ✅ Implemented |
| AI Summary Service | 8085 | HTTP | ✅ Implemented |
| Auth Service | 8086 | HTTP | ✅ Implemented |
